...
def resolve_custom_audio_file(
    ...
    *,
    ...
    # The embedded OpenMediaFlow API may provide narration generated by its native
    # host runtime. That shared input is accepted only when it resolves inside the
    # mounted local_videos directory; arbitrary server paths remain forbidden.
    try:
        return file_security.resolve_path_within_directory(
